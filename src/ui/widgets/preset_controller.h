...
public:
    ...
    static bool overwritePreset(PresetManager& manager, GradientConfig& file, preset::GradientPreset preset, const std::string& new_name, const uint32_t index);
    static bool addPreset(PresetManager& manager, GradientConfig& file, preset::GradientPreset preset, const std::string& new_name);
